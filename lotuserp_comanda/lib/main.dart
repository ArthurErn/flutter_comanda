...
import 'package:lotuserp_comanda/views/login/layout/login_dropdown.dart';
...
import 'package:lotuserp_comanda/views/splashscreen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (_pageState) {
      ...
      case 1:
        ...
        _loginHeight = _keyboardVisible ? windowHeight : windowHeight - 320;
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              "Inovação e tecnologia na palma da mão.",
